package com.androidcapstone.symptommanagement.server.auth;
		...
		public OAuth2Config() throws Exception {
			...
			UserDetailsService svc = new InMemoryUserDetailsManager(
					Arrays.asList(
							...
							User.create("patient1", "pass", "USER"),
							User.create("patient2", "pass", "USER"),
							User.create("patient3", "pass", "USER"),
							User.create("patient4", "pass", "USER"),
							User.create("doctor1", "pass", "USER"),
							User.create("doctor2", "pass", "USER")));
